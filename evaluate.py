...
def mtkd_task_eval(opt):    
    ...
    visual_encoder.load_state_dict(torch.load(opt.saved_model + '_' + opt.saved_iter + '_' + 'timt_visual_encoder' +'.pth', map_location=device))
    encoder.load_state_dict(torch.load(opt.saved_model + '_' + opt.saved_iter + '_' + 'timt_sequential_encoder' +'.pth', map_location=device))
    tgt_decoder.load_state_dict(torch.load(opt.saved_model + '_' + opt.saved_iter + '_' + 'timt_decoder' +'.pth', map_location=device))
