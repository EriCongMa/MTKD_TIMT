...
from task.train_mtkd import mtkd_train
...
if __name__ == '__main__':
    ...
    parser.add_argument("--TIMT_Weight", type = float, default = 0.2)
    parser.add_argument("--KD_Weight", type = float, default = 0.8)

    parser.add_argument("--ImageEncoder_KD_Weight", type = float, default = 1.0)
    parser.add_argument("--SequentialEncoder_KD_Weight", type = float, default = 1.0)
    parser.add_argument("--Decoder_KD_Weight", type = float, default = 1.0)
